...
* `03_gromacs_md/`: GROMACS `.mdp` configuration files (minimization, NVT, NPT, production).
* `04_analysis/`: Python scripts and Jupyter notebooks for trajectory analysis (RMSD, RMSF, SASA, and pocket volume).
* `reports/`: The final PDF report.
